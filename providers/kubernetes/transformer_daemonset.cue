...
// DaemonSet Transformer - Creates Kubernetes DaemonSet resources
#DaemonSetTransformer: core.#Transformer & {
	creates: "k8s.io/api/apps/v1.DaemonSet"
		...
		output: [
			schema.#DaemonSet & {
				...
				spec: {
					...
					revisionHistoryLimit: _deploymentType.revisionHistoryLimit | *10
